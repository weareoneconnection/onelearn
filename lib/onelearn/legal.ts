// Draft legal documents. Bracketed placeholders (【…】) must be completed and the
// text reviewed by qualified counsel before commercial launch.
...
export const LEGAL_DOCS: Record<LegalDocId, { zh: LegalDoc; en: LegalDoc }> = {
  terms: {
    zh: {
      ...
      updated: UPDATED,
      sections: [
        { heading: "1. 协议主体", body: ["本协议由你与【运营主体公司全称】（以下简称“我们”）就使用 OneLearn（以下简称“本服务”）订立。注册、登录或使用本服务，即表示你已阅读并同意本协议、《隐私政策》与《退款规则》。"] },
        ...
        { heading: "9. 法律适用与争议解决", body: ["本协议适用【适用法律，例如：中华人民共和国法律】。争议协商不成的，提交【管辖法院或仲裁机构】解决。"] },
        { heading: "10. 联系我们", body: ["邮箱：【客服邮箱】。我们将在 【7】 个工作日内答复。"] },
      ],
    },
    en: {
      ...
      updated: UPDATED,
      sections: [
        { heading: "1. Parties", body: ["These terms are an agreement between you and 【Operating company legal name】 (“we”) for the use of OneLearn (the “Service”). By signing up, signing in, or using the Service you accept these terms, the Privacy Policy, and the Refund Policy."] },
        ...
        { heading: "9. Governing law", body: ["These terms are governed by 【governing law】. Disputes not resolved amicably are submitted to 【court or arbitration body】."] },
        { heading: "10. Contact", body: ["Email: 【support email】. We respond within 【7】 business days."] },
      ],
    },
  },
  privacy: {
    zh: {
      ...
      sections: [
        ...
        { heading: "3. 委托处理与第三方", body: ["为提供服务，我们会将必要数据交由以下服务商处理：OpenAI（AI 生成与资料检索）、Clerk（登录认证）、Stripe（支付）、Turso / Cloudflare（数据存储）、Vercel（网站托管）、Resend（复习提醒邮件发送）、【错误监控服务，如 Sentry】。", "上述服务商可能位于中国境外。使用本服务即表示你知悉并同意为提供服务所必需的个人信息出境；我们将按照适用法律（包括《个人信息保护法》）的要求履行相应义务【如需完成个人信息出境安全评估、标准合同备案等，请在此说明】。"] },
        { heading: "4. 保存期限", body: ["账号存续期间保存你的学习数据；注销账号后 【30】 天内删除或匿名化，法律法规要求保存的（如账单记录）除外。"] },
        { heading: "5. 你的权利", body: ["你可以查阅、复制、更正、删除你的个人信息，撤回同意或注销账号。请通过【客服邮箱】联系我们，我们将在 【15】 个工作日内处理。"] },
        ...
        { heading: "8. 联系我们", body: ["个人信息保护负责人：【姓名或岗位】，邮箱：【隐私邮箱】，地址：【公司注册地址】。"] },
      ],
    },
    en: {
      ...
      sections: [
        ...
        { heading: "3. Processors", body: ["We share the data needed to run the Service with: OpenAI (AI generation and retrieval), Clerk (authentication), Stripe (payments), Turso / Cloudflare (storage), Vercel (hosting), Resend (review reminder emails), and 【error monitoring, e.g. Sentry】.", "These providers may be located outside your country. We transfer personal information across borders only as needed to provide the Service and in line with applicable law 【describe the cross-border transfer mechanism】."] },
        ...
        { heading: "5. Your rights", body: ["You may access, copy, correct, or delete your personal information, withdraw consent, or delete your account by contacting 【support email】. We respond within 【15】 business days."] },
        ...
        { heading: "8. Contact", body: ["Privacy contact: 【name or role】, email: 【privacy email】, address: 【registered address】."] },
      ],
    },
  },
  refund: {
    zh: {
      ...
      updated: UPDATED,
      sections: [
        { heading: "1. 首次订阅冷静期", body: ["首次开通付费套餐后 【7】 天内，且当期已使用 AI 点数不超过 【20%】 的，可申请全额退款。"] },
        { heading: "2. 取消订阅", body: ["你可随时取消自动续费。取消后不再扣费，当前计费周期结束前仍可使用付费权益；已开始的计费周期原则上不按比例退款。"] },
        { heading: "3. 年付套餐", body: ["年付套餐超过冷静期后申请退款的，按【剩余完整月份 × 月付价格折算 / 不予退款】处理。"] },
        ...
        { heading: "6. 申请方式", body: ["请发送邮件至【客服邮箱】，注明账号邮箱与账单编号。审核通过后原路退回，到账时间以支付机构为准（通常 5–10 个工作日）。"] },
      ],
    },
    en: {
      ...
      updated: UPDATED,
      sections: [
        { heading: "1. First-subscription cooling-off period", body: ["Within 【7】 days of your first paid subscription, and if you have used no more than 【20%】 of that period's AI credits, you may request a full refund."] },
        ...
        { heading: "3. Annual plans", body: ["Refund requests for annual plans after the cooling-off period are handled as 【remaining full months × monthly price / not refundable】."] },
        ...
        { heading: "6. How to request", body: ["Email 【support email】 with your account email and invoice number. Approved refunds go back to the original payment method, usually within 5–10 business days depending on the payment provider."] },
      ],
    },
  },
};
