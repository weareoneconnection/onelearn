    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "语音对话：点击导师区域右上角的「语音对话」，就可以像打电话一样直接和导师说话，随时可以打断它。通话时会显示实时字幕，也可以静音或随时结束。语音导师需要登录，按实际通话时长计入每月语音额度（免费版 5 分钟、个人版 60 分钟、专业版 300 分钟），单次通话最长 10 分钟。语音直接连接 OpenAI，在无法访问 OpenAI 的网络（如中国大陆）下暂时不可用，请使用文字导师。",
      ...
      },
      {
        ...
        body: [
          ...
          { list: [
            ...
            "导师问答：每次 1 点",
            "练习、复习、再次打开已生成的内容：免费",
            "语音导师：不扣 AI 点数，按每月语音时长计（免费版 5 分钟、个人版 60 分钟、专业版 300 分钟）",
          ] },
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Voice: click \"Voice\" at the top right of the tutor panel to talk with the tutor like a phone call — you can interrupt at any time. Live captions appear during the call, and you can mute or hang up anytime. The voice tutor requires signing in and counts actual call time against your monthly voice allowance (5 minutes on Free, 60 on Personal, 300 on Pro), with up to 10 minutes per call. Voice connects directly to OpenAI, so it isn't available on networks that block OpenAI (such as mainland China) — use the text tutor there.",
      ...
      },
      {
        ...
        body: [
          ...
          { list: [
            ...
            "Voice tutor: no AI credits; uses your monthly voice minutes (5 on Free, 60 on Personal, 300 on Pro)",
          ] },
